...
def inference_model():
    ...
    #detect_model
    model = YOLO("C:/Users/amuse/PycharmProjects/pythonProject3/runs/segment/best.pt")  # best_model
    #results = model.predict(source='D:/Crosswalk.v3i.yolov8/test/images/', conf=0.25)
    results = model.predict('D:/Crosswalk.v3i.yolov8/test/images/', conf = 0.25)
    ...
    for r in range(len(results)):
        ...
        im.save("D:/Crosswalk.v3i.yolov8/test/result/" + str(r) + 'results.jpg')  # save image
